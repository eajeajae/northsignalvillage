<!-- Modal -->
<div class="modal fade" id="showMyClearanceModal" tabindex="-1" aria-labelledby="showMyClearanceModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form class="form-group row g-3" method="post" enctype="multipart/form-data" id="myClearanceshowForm">
          {{ csrf_field() }}
          <input type="hidden" id="show_myclearance_id"> 
          <div class="d-inline-flex p-2 justify-content-end">
						<div class="">
							<select id="show_myclearance_typeofrequest_id" name="typeofrequest_id" class="form-select" disabled>
            ...
            <div class="">
              <select id="show_myclearance_status" name="status" class="form-select" disabled>
            ...
            <div class="col-sm-12">
              <div class="input-group">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="purpose" id="show_myclearance_purpose" name="purpose" readonly>
                </div>
              </div>
            </div>
            <div class="col-sm-12">
                ...
                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="isRegistered" id="show_myclearance_isRegistered" name="isRegistered" readonly>
              </div>
            </div>
            <div class="col-sm-12">
							<div class="input-group mb-3">
								<span class="input-group-text" id="havePendingCase">Do you have pending case before the Barangay/Lupon Tagamayapa?:</span>
								<input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="havePendingCase" id="show_myclearance_havePendingCase" name="havePendingCase" readonly>
							</div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-8">
              ...
              <input type="text" class="form-control" id="show_myclearance_name" name="name" readonly>
            </div>
            <div class="col-sm-3">
              <label for="gender" class="form-label">Gender :</label><br>
                <input class="form-control" type="text" name="gender" id="show_myclearance_gender" readonly>
              </div>
            </div>
            <div class="col-sm-4">
              <label for="birthdate" class="form-label">Birthday :</label>
              <input type="date" class="datepicker form-control" data-date-format="mm/dd/yyyy" class="form-control" id="show_myclearance_birthdate" name="birthdate" readonly>
            </div>
            <div class="col-sm-4">
              <label for="p_birth" class="form-label">Place of Birth :</label>
              <input type="text" class="form-control" id="show_myclearance_p_birth" name="p_birth"readonly>
            </div>
            <div class="col-sm-4">
              <label for="nationality" class="form-label">Nationality :</label>
              <input type="text" class="form-control" id="show_myclearance_nationality" name="nationality" readonly>
            </div>
            <div class="col-sm-6">
              <label for="contact_num" class="form-label">Contact No. :</label>
              <input type="text" class="form-control" id="show_myclearance_contact_num" name="contact_num" readonly>
            </div>
            <div class="col-sm-6">
              <label for="c_status" class="form-label">Civil Status :</label>
              <select id="show_myclearance_c_status" class="form-select" name="c_status" readonly>
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="show_myclearance_addressNo" name="addressNo" readonly>
            </div>
            <div class="col-sm-8">
            	<select id="show_myclearance_street" name="street" class="form-select" readonly>
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="show_myclearance_addressZone" name="addressZone" readonly>
            </div>
            <div class="col-sm-12">
              <label for="businessAddress" class="form-label">Business Address (for Business Clerance Only) :</label>
              <input type="text" class="form-control" id="show_myclearance_businessAddress" name="businessAddress" readonly>
            </div>
            <div class="col-sm-8">
              <label for="provincialAddress" class="form-label">Provincial Address :</label> 
              <input type="text" class="form-control" id="show_myclearance_provincialAddress" name="provincialAddress" readonly>
            </div>
            <div class="col-sm-4">
              <label for="living" class="form-label">Year since living in the Barangay:</label>
              <input type="text" class="form-control" id="show_myclearance_yearLiving" name="yearLiving" readonly>
            </div>
            <div class="col-sm-12">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="i-certify" id="show_myclearance_areYouSure" name="areYouSure" checked>
