...
<div class="container">
  ...
  <div class="row">
		<div class="col-sm-4">
			@if(empty($incartclearanceRequests))
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<h2 class="card-text">{{$incartclearanceRequests}}</h2>
							<small class="text-muted">Total Count</small>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4">
			@if(empty($pendingclearanceRequests))
			<div class="card mb-3" style="max-width: 540px; background-color: #ECECEC;">
				<div class="row g-0">
					<div class="col-md-4">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<h2 class="card-text">---</h2>
							<a href="{{route('clearance.pending')}}" class="card-text"><small class="text-muted">Total Count</small></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<h2 class="card-text">{{$pendingclearanceRequests}}</h2>
							<a href="{{route('clearance.pending')}}" class="card-text"><small class="text-muted">Total Count</small></a>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-4">
			@if(empty($doneclearanceRequests))
			<div class="card mb-3" style="max-width: 540px; background-color: #ECECEC;">
				<div class="row g-0">
					<div class="col-md-4">
			...
			<div class="card mb-3" style="max-width: 540px; background-color: #ECECEC;">
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							<p style="font-size: 12px;" class="card-title card_tags">Received by the residents</p>
							<h2 class="card-text">{{$doneclearanceRequests}}</h2>
							<small class="text-muted">Total Count</small>
						</div>
					</div>
				</div>
...
@include('clearance.editClearance')
