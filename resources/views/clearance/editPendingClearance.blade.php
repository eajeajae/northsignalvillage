<!-- Modal -->
<div class="modal fade" id="editPendingClearanceModal" tabindex="-1" aria-labelledby="editPendingClearanceModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form class="form-group row g-3" method="post" enctype="multipart/form-data" id="pendingClearanceForm">
          {{ csrf_field() }}
          <input type="hidden" id="edit_clearance_id"> 
          <input type="hidden" id="edit_clearance_user_id" name="user_id"> 
          <div class="d-inline-flex p-2 justify-content-end">
						<div class="">
							<select id="edit_clearance_typeofrequest_id" name="typeofrequest_id" class="form-select">
            ...
            <div class="">
							<select id="edit_clearance_status" name="status" class="form-select">
            ...
            <div class="col-sm-12">
              <div class="input-group">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="purpose" id="edit_clearance_purpose" name="purpose">
                </div>
              </div>
            </div>
            <div class="col-sm-12">
                ...
                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="isRegistered" id="edit_clearance_isRegistered" name="isRegistered">
              </div>
            </div>
            <div class="col-sm-12">
							<div class="input-group mb-3">
								<span class="input-group-text" id="havePendingCase">Do you have pending case before the Barangay/Lupon Tagamayapa?:</span>
								<input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="havePendingCase" id="edit_clearance_havePendingCase" name="havePendingCase">
							</div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-8">
              ...
              <input type="text" class="form-control" id="edit_clearance_name" name="name" readonly>
            </div>
            <div class="col-sm-3">
              <label for="gender" class="form-label">Gender :</label><br>
                <input class="form-control" type="text" name="gender" id="edit_clearance_gender" readonly>
              </div>
            </div>
            <div class="col-sm-4">
              <label for="birthdate" class="form-label">Birthday :</label>
              <input type="date" class="datepicker form-control" data-date-format="mm/dd/yyyy" class="form-control" id="edit_clearance_birthdate" name="birthdate" readonly>
            </div>
            <div class="col-sm-4">
              <label for="p_birth" class="form-label">Place of Birth :</label>
              <input type="text" class="form-control" id="edit_clearance_p_birth" name="p_birth">
            </div>
            <div class="col-sm-4">
              <label for="nationality" class="form-label">Nationality :</label>
              <input type="text" class="form-control" id="edit_clearance_nationality" name="nationality">
            </div>
            <div class="col-sm-6">
              <label for="contact_num" class="form-label">Contact No. :</label>
              <input type="text" class="form-control" id="edit_clearance_contact_num" name="contact_num" readonly>
            </div>
            <div class="col-sm-6">
              <label for="c_status" class="form-label">Civil Status :</label>
              <select id="edit_clearance_c_status" class="form-select" name="c_status">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="edit_clearance_addressNo" name="addressNo" readonly>
            </div>
            <div class="col-sm-8">
            	<select id="edit_clearance_street" name="street" class="form-select">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="edit_clearance_addressZone" name="addressZone" >
            </div>
            <div class="col-sm-12">
              <label for="businessAddress" class="form-label">Business Address (for Business Clerance Only) :</label>
              <input type="text" class="form-control" id="edit_clearance_businessAddress" name="businessAddress">
            </div>
            <div class="col-sm-8">
              <label for="provincialAddress" class="form-label">Provincial Address :</label>
              <input type="text" class="form-control" id="edit_clearance_provincialAddress" name="provincialAddress">
            </div>
            <div class="col-sm-4">
              <label for="living" class="form-label">Year since living in the Barangay:</label>
              <input type="text" class="form-control" id="edit_clearance_yearLiving" name="yearLiving">
            </div>
            <div class="col-sm-12">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="i-certify" id="edit_clearance_areYouSure" name="areYouSure" checked>
          ...
          <div class="modal-footer">
            <div class="d-flex gap-2 justify-content-end">
              <button class="btn btn-info" type="button" id="clearanceGeneratebtn" style="color:white;">Create Clearance</button>
              <button class="btn btn-success" type="submit" id="pendingClearanceUpdate">Submit</button>
