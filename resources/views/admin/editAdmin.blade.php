        ...
        <form id="updateAdminForm" method="post" enctype="multipart/form-data" class="row g-3">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
					...
					<div class="d-inline-flex p-2 justify-content-end">
						<div class="">
							<select id="edit_admin_role" name="role" class="form-select">
            ...
            <div class="ms-3">
							<select id="edit_admin_status" name="status" class="form-select">
								<option selected>Change Status</option>
					...
					<div class="col-sm-3">
						<div class="justify-content-center ms-5 mt-3" id="edit_admin_avatar">
					...
					<div class="col-sm-9">
						<div class="row">
							...
							<div class="form-group col-sm-3"> 
								...
								<input type="text" class="form-control" id="edit_admin_age" name="age">
							</div> 
              <div class="form-group col-sm-3"> 
								<label for="gender" class="form-label">Gender :</label>
								<input type="text" class="form-control" id="edit_admin_gender" name="gender">
							</div> 
							<div class="form-group col-sm-6"> 
								<label for="birthdate" class="form-label">Birthday :</label>
								<input type="date" class="datepicker form-control" data-date-format="mm/dd/yyyy" class="form-control" id="edit_admin_birthday" name="birthday">
							</div>
							<div class="form-group col-sm-6">
								<label for="phone_num" class="form-label">Contact No. :</label>
								<input type="text" class="form-control" id="edit_admin_phone_num" name="phone_num">
							</div>
							<div class="col-sm-6">
							...
							<div class="form-group col-sm-12 mb-5"> 
								...
								<input type="email" class="form-control" id="edit_admin_email" name="email">
							</div> 
							<h6>Home Address</h6>

							<div class="form-group col-sm-2">
								<label for="address" class="form-label">No :</label>
								<input type="text" class="form-control" id="edit_admin_addressNo" name="addressNo">
							</div>
							<div class="form-group col-sm-8">
							<label for="inputState" class="form-label">Street</label>
								<select id="edit_admin_street" name="street" class="form-select">
							...
							<div class="form-group col-sm-2">
								...
								<input type="text" class="form-control" id="edit_admin_addressZone" name="addressZone">
							</div>
						</div>
					</div>
