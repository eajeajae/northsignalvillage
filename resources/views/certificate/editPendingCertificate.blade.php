<!-- Modal -->
<div class="modal fade" id="editPendingCertificateModal" tabindex="-1" aria-labelledby="editPendingCertificateModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Request for certificate</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form class="form-group row g-3" method="post" id="pendingCertificateForm" enctype="multipart/form-data">
          @csrf
          <!-- end of barangay certificate --> 
          <input type="hidden" id="edit_certificate_user_id" name="user_id">
          <input type="hidden" id="edit_certificate_id">
          <div class="d-inline-flex p-2 justify-content-end">
						<div class="">
							<select id="edit_certificate_typeofrequest_id" name="typeofrequest_id" class="form-select" readonly>
            ...
            <div class="">
							<select id="edit_certificate_status" name="status" class="form-select">
            ...
            <div class="col-sm-12">
              <div class="input-group">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="purpose" id="edit_certificate_purpose" name="purpose">
                </div>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" id="edit_certificate_isRegistered" name="isRegistered">
                </div>
            </div>
            <div class="col-sm-12">
              <div class="input-group mb-3">
                  <span class="input-group-text" id="purpose">Do you have pending case before the Barangay/Lupon Tagamayapa?:</span>
                  <input type="text" class="form-control" id="edit_certificate_havePendingCase" name="havePendingCase">
                </div>
            </div>
          </div> 
          <!-- end of row g-3 -->
          ...
          <!-- start of personal information -->
            <div class="col-sm-9">
              ...
              <input type="text" class="form-control" id="edit_certificate_name" name="name" readonly>
            </div>
            <div class="col-sm-3">
              <label for="gender" class="form-label">Gender :</label>
              <input type="text" class="form-control" id="edit_certificate_gender" name="gender" readonly>
              <br>
            </div>
            <div class="col-sm-4">
              <label for="birthdate" class="form-label">Birthday :</label>
              <input type="date" class="datepicker form-control" data-date-format="mm/dd/yyyy" class="form-control" id="edit_certificate_birthdate" name="birthdate" readonly>
            </div>
            <div class="col-sm-4">
              <label for="p_birth" class="form-label">Place of Birth :</label>
              <input type="text" class="form-control" id="edit_certificate_p_birth" name="p_birth">
            </div>
            <div class="col-sm-4">
              <label for="nationality" class="form-label">Nationality :</label>
              <input type="text" class="form-control" id="edit_certificate_nationality" name="nationality">
            </div>
            <div class="col-sm-6">
              <label for="contact_num" class="form-label">Contact No. :</label>
              <input type="text" class="form-control" id="edit_certificate_contact_num" name="contact_num"readonly>
            </div>
            <div class="col-sm-6">
              <label for="c_status" class="form-label">Civil Status :</label>
              <select id="edit_certificate_c_status" class="form-select" name="c_status">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="edit_certificate_addressNo" name="addressNo" placeholder="No." readonly>
            </div>
            <div class="col-sm-8">
              <select id="edit_certificate_street" name="street" class="form-select">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="edit_certificate_yearLiving" name="yearLiving">
            </div>
            <div class="col-sm-12">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="i-certify" id="edit_certificate_areYouSure" name="areYouSure" checked>
          ...
          <div class="d-flex gap-2 justify-content-end">
            <button class="btn btn-info" type="button" id="certificateGeneratebtn" style="color:white;">Create Certificate</button>
            <button class="btn btn-success" type="submit" id="pendingCertificateUpdate">Update</button>
