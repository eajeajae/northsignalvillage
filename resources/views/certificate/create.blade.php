...
@section('title')
	Request form for Barangay Certificate
@endsection 
    ...
    @endif
		<div class="card card-form">
			<div class="card-body mx-5 my-5">
			  <form class="form-group row g-3" action="{{route('certificate.store')}}" method="post" id="certificateForm" enctype="multipart/form-data">
          {{ csrf_field() }}
          <!-- barangay certificate -->
          <div id="barangayCertificate">
              <div class="card-body row certificate_data">
                ...
                <div class="col-md-6">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="typeofrequest_id">{{$typeofrequest_id->typeofdoc}}</label>
										<label class="form-check-label" for="price" id="price" name="price">{{$typeofrequest_id->price}}</label>
                  </div>
                </div>
               @endforeach
              </div>
          ...
          <div class="d-grid gap-2 justify-content-end">
            <button class="btn btn-success" type="submit" id="certificateSubmit">Submit</button>
          </div>
        </form>
      </div>
    </div>
