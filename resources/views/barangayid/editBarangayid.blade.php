<!-- Modal -->
<div class="modal fade" id="editBarangayIdModal" tabindex="-1" aria-labelledby="editBarangayIdModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="updateBarangayidForm" method="post" enctype="multipart/form-data" class="row g-3">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <input type="hidden" id="edit_barangayid_user_id" name="user_id">
