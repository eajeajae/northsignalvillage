<!-- Modal -->
<div class="modal fade" id="editMyBarangayidModal" tabindex="-1" aria-labelledby="editMyBarangayidModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="myBarangayidEditForm" method="post" enctype="multipart/form-data" class="row g-3">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
					<input type="hidden" id="edit_mybarangayid_id">
					<div class="col-sm-3">
						<div class="justify-content-center ms-5 mt-3" id="edit_mybarangayid_id_img">
						...
						<div class="row">
							<div class="col-sm-12">
								<br>
									...
									<input type="text" class="form-control" id="edit_mybarangayid_fullname" name="fullname">
								</div>
								<div class="col-sm-6">
									<label for="birthdate" class="form-label">Birthday :</label>
									<input type="date" class="datepicker form-control" data-date-format="mm/dd/yyyy" class="form-control" id="edit_mybarangayid_birthdate" name="birthdate">
								</div>
								<div class="col-sm-6">
									<label for="contactno" class="form-label">Contact No. :</label>
									<input type="text" class="form-control" id="edit_mybarangayid_contactno" name="contactno">
								</div>
								...
								<div class="col-sm-2">
									<br>
									<input type="text" class="form-control" id="edit_mybarangayid_addressNo" name="addressNo" placeholder="No.">
								</div>		
								<div class="form-group col-sm-8">
									<label for="inputState" class="form-label">Street</label>
									<select id="edit_mybarangayid_street" name="street" class="form-select">
								...
								<div class="form-group col-sm-2">
									...
									<input type="text" class="form-control" id="edit_mybarangayid_addressZone" name="addressZone">
								</div>
								<div class="col-sm-6">
									<label for="precintNo" class="form-label">Precint No. :</label>
									<input type="text" class="form-control" id="edit_mybarangayid_precintNo" name="precintNo">
								</div>
								...
								<div class="col-sm-12">
									...
									<input type="text" class="form-control" id="edit_mybarangayid_contactperson" name="contactperson">
								</div>
								<div class="col-sm-12">
									<label for="guardianContact" class="form-label">Contact No. :</label>
									<input type="text" class="form-control" id="edit_mybarangayid_guardianContact" name="guardianContact">
								</div>
								<div class="col-sm-12">
									<label for="guardianAddress" class="form-label">Address :</label>
									<input type="text" class="form-control" id="edit_mybarangayid_guardianAddress" name="guardianAddress">
								</div>
								<div class="modal-footer">
									<button id="mybarangayidUpdate" type="submit" class="btn btn-success">Update</button>
