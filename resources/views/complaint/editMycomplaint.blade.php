<!-- Modal -->
<div class="modal fade" id="editMyComplaintModal" tabindex="-1" aria-labelledby="editMyComplaintModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-group row g-3" method="post" id="editMyComplaintForm" enctype="multipart/form-data">
					{{ csrf_field() }}
          <input type="hidden" id="edit_mycomplaint_id">
          <div class="d-inline-flex p-2 justify-content-end">
            <div class="">
              <select id="edit_mycomplaint_status" name="status" class="form-select" readonly>
                ...
                <option value="dropped/widthdrawn">Dropped/Widthdrawn</option>
					...
					<div class="col-sm-12">
						...
						<input type="text" class="form-control" id="edit_mycomplaint_complainantName" name="complainantName" readonly>
					</div>
					<div class="col-sm-12">
						<label for="complainantAddress" class="form-label">Complainant's Address (Address ng nagrereklamo) :</label>
					</div>
					<div class="col-sm-2">
						<input type="text" class="form-control" id="edit_mycomplaint_cAddressno" name="cAddressno" disabled>
					</div>
					<div class="col-sm-8">
						<select id="edit_mycomplaint_cStreet" name="cStreet" class="form-select" disabled>
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" id="edit_mycomplaint_cAddresszone" name="cAddresszone" disabled>
					</div>
					<div class="col-sm-7">
						<label for="respondentName" class="form-label">Name (Buong pangalan ng inirereklamo) :</label>
						<input type="text" class="form-control" id="edit_mycomplaint_respondentName" name="respondentName">
					</div>
					<div class="col-sm-5">
						<label for="respondentAge" class="form-label">Age (Edad ng inirereklamo) :</label>
						<input type="text" class="form-control" id="edit_mycomplaint_respondentAge" name="respondentAge">
					</div>
					<div class="col-sm-2">
						<input type="text" class="form-control" id="edit_mycomplaint_rAddressno" name="rAddressno" placeholder="No.">
					</div>
					<div class="col-sm-8">
						<select id="edit_mycomplaint_rStreet" name="rStreet" class="form-select">
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" id="edit_mycomplaint_rAddresszone" name="rAddresszone" placeholder="Zone">
					</div>
					<div class="col-sm-12">
            <label for="edit_mycomplaint_complaintDesc" class="form-label">Complaint:</label>
            <select id="edit_mycomplaint_complaintDesc" name="edit_mycomplaint_complaintDesc" class="form-select">
              ...
              <option value="Tresspass">Tresspass</option>
					...
					<div class="col-sm-2">
						...
						<input type="text" class="form-control" id="edit_mycomplaint_locationAddressno" name="locationAddressno">
					</div>
          <div class="col-sm-5">
						<label for="locationStreet" class="form-label">Location (Lugar ng pinangyarihan) :</label>
						<input type="text" class="form-control" id="edit_mycomplaint_locationStreet" name="locationStreet">
					</div>
					<div class="col-sm-5">
						<label for="complaintDate" class="form-label">Date (Kailan nangyari) :</label>
						<input type="date" class="form-control" id="edit_mycomplaint_complaintDate" name="complaintDate" data-date-format="YYYY MM DD">
					</div>
					<div class="col-sm-12">
						<label for="complaintWhy" class="form-label">Why (Isalaysay kung bakit nagreklamo) :</label>
						<textarea class="form-control" id="edit_mycomplaint_complaintWhy" name="complaintWhy" rows="3"></textarea>
					</div>
					<div class="col-sm-12">
						<label for="complainantPrayer" class="form-label">Prayer (Isalaysay ang ang nais mangyari) :</label>
						<textarea class="form-control" id="edit_mycomplaint_complainantPrayer" name="complainantPrayer" rows="3"></textarea>
					</div>
					<div class="col-sm-12">
						<div class="form-check">
							<input class="form-check-input" type="checkbox" value="i-certify" id="edit_mycomplaint_complainantAgrees" name="complainantAgrees" checked>
